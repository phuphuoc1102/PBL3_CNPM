...
<body>
	<div class="container">
		...
		<form:form class="form" action="dang-ky" method="post"
			modelAtribute="customer">
			...
			<div class="row">
				<div class="col-sm-6">
					...
					<div class="mb-3">
						...
						<form:input type="text" class="form-control" id="tenDangNhap"
							name="tenDangNhap" path="tenDangNhap" />
					</div>
					<div class="mb-3">
