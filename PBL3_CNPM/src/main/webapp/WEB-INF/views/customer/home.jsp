...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                ...
                <div class="nav-item dropdown">
                    <a href="dang-nhap" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Pages</a>
                ...
                <a href="<c:url value='/dang-nhap'/>"class="nav-item nav-link nav-contact bg-primary text-white px-5 ms-lg-5">Đăng nhập <i class="bi bi-arrow-right"></i></a>
            </div>
        </div>
    </nav>
    <!-- Navbar End -->
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="border-start border-5 border-primary ps-5 mb-5" style="max-width: 600px;">
                ...
                <h1 class="display-5 text-uppercase mb-0">Dịch vụ chăm sóc thú cưng</h1>
            </div>
            <div class="row g-5">
                <div class="col-md-6">
    ...
    <!-- Products Start -->
    <div class="container-fluid py-5">
    <p>productsize = ${products.size()}</p>
    <p>customersize = ${customer.size()}</p>
        <div class="container">
            <div class="border-start border-5 border-primary ps-5 mb-5" style="max-width: 300px;">
                <h6 class="text-primary text-uppercase">Sản phẩm</h6>
                <h1 class="display-5 text-uppercase mb-0">Sản phẩm tốt nhất cho bạn</h1>
