...
<<!-- Favicon -->
    ...
    <link href="<c:url value='/template/lib/owlcarousel/assets/owl.carousel.minprod.css'/>" rel="stylesheet">

    <!-- Customized Bootstrap Stylesheet -->
    <link href="<c:url value='/template/css/bootstrap.minprod.css' />" rel="stylesheet">

    <!-- Template Stylesheet -->
    <link href="<c:url value='/template/css/styleprod.css' />" rel="stylesheet">
</head>
<body>
...
<script src="https://code.jquery.com/jquery-3.4.1.min.js"></script>
    ...
    <script src="<c:url value='/template/lib/animate/wow.min.js'/>"> </script>

       <script src="<c:url value='/template/lib/animate/easing.min.js'/>"> </script>

       <script src="<c:url value='/template/lib/animate/waypoints.min.js'/>"> </script>

       <script src="<c:url value='/template/animate/owlcarousel/owl.carousel.min.js'/>"> </script>

    <!-- Template Javascript -->
    <script src="js/main.js"></script>
       <script src="<c:url value='/template/animate/main.js'/>"> </script>
</body>
</html>